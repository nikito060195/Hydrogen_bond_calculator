...
def run_recursive(file):
    ...
    # Define limites da box e PBC
    box = (0, 60, 0, 60, 0, 60) # Configura tupla com limites da caixa
    pbc = (True, True, False) # Abilita PBC para x e y
    ...
    real_analysis = hb.HBondAnalysis(
        ...
        # box_limits=box,  # Deixe comentado para usar extração automática
        # pbc=pbc,         # Deixe comentado para usar extração automática
        set_len=3.5,
        set_angle=30,
        n_cpus=10
    )
